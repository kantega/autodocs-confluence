...
public class MavenTest {
    ...
    public void testCoords() throws ParserConfigurationException {
        ...
        final Validation<String, List<Either<String, PluginDoc>>> documentationFor =
        ...
        documentationFor.forEach(eithers -> eithers.forEach(either->System.out.println(either.<String>either(f->f,s->s.documentRoot.toString()))));
    }
}
